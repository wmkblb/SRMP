...
import trainers.mmrl_SRMP
import trainers.mmrlpp
import trainers.maple_SRMP
...
def extend_cfg(cfg):
    ...
    cfg.TRAINER.MAPLE_SRMP = CN()
    cfg.TRAINER.MAPLE_SRMP.SPLIT_RATIO = 0.5
    cfg.TRAINER.MAPLE_SRMP.INNER_LR = -1.0
    ...
    cfg.TRAINER.MMRL_SRMP = CN()
    cfg.TRAINER.MMRL_SRMP.SPLIT_RATIO = 0.5
    # A negative value follows the outer optimizer's current learning rate.
    cfg.TRAINER.MMRL_SRMP.INNER_LR = -1.0
